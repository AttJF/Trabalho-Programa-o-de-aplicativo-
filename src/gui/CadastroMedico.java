...
public class CadastroMedico extends JFrame {
	...
	public CadastroMedico() {
		...
		textField.setBounds(49, 47, 404, 20);
		...
		btnNewButton.setBounds(358, 130, 106, 51);
		...
		btnNewButton_1.setBounds(152, 158, 177, 23);
		contentPane.add(btnNewButton_1);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(10, 360, 454, 4);
		contentPane.add(separator_1);
		
		JLabel lblNewLabel_5 = new JLabel("Registro do Conselho Federal de Medicina");
		lblNewLabel_5.setBounds(10, 378, 204, 14);
		contentPane.add(lblNewLabel_5);
		
		textField_1 = new JTextField();
		textField_1.setBounds(224, 375, 229, 20);
		...
		lblNewLabel_14.setBounds(10, 407, 88, 14);
		contentPane.add(lblNewLabel_14);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(91, 403, 364, 22);
