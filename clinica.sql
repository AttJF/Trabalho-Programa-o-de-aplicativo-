...
CREATE TABLE `clinica`.`medico` (`IDmedico` INT NOT NULL AUTO_INCREMENT , `crm` INT NOT NULL , `nome` VARCHAR(50) NOT NULL , `telefone` VARCHAR(50) NOT NULL , `IDendereco` INT NOT NULL , `IDespecialidade` INT NOT NULL , PRIMARY KEY (`IDmedico`)) ENGINE = InnoDB;
